# To make the installation process of the 'PyDiff' project easier, comment this file out.
# import math
# import random
# import torch
...
#     def __init__(self, out_size, channel_multiplier=2, resample_kernel=(1, 3, 3, 1), stddev_group=4, narrow=1, in_chn=3):
...
#         conv_body = [ConvLayer(in_chn, channels[f'{out_size}'], 1, bias=True, activate=True)]
